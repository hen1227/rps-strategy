...
// Gold rather than the accent green, which everywhere else in this app means
// "your turn" or "this is live", neither of which a title is.
//
...
export default function TitleTag({ title, size = 'small' }: TitleTagProps) {
  ...
  return (
    <Text
      ...
      style={[styles.tag, size === 'medium' && styles.medium, size === 'large' && styles.large]}
    >
      {tag}
    </Text>
  );
