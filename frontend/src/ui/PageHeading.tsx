...
import type { UpTarget } from '@/navigation/upFrom';
...
// nothing in the sidebar leads back from one run of a bot series to the runs —
...
//
// `back` takes null as well as a target, which is what a page whose own row in
// the navigation comes and goes hands straight through — see `useUpTarget`. A
// page that is always a section passes nothing at all.
