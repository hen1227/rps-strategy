...
import { ANALYSIS_PRESET_LABELS } from '../engine/gameAnalysis';
import { REVIEW_PRESETS } from '../engine/rpsfishClient';
import { colors, radius } from '../theme';

const PRESET_KEYS = Object.keys(REVIEW_PRESETS);
 ...
 */
export default function AnalysisPresetPicker({ onChange, value }) {
  return (
